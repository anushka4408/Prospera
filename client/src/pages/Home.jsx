                        ...
                        <div className="w-full h-full grid grid-rows-[85%_15%] text-8xl">
                            <div className="w-full h-full grid grid-rows-[50%_50%] justify-center pb-2 items-end">
                                ...
                                <div className="grid grid-cols-[10%_90%]">
                                    ...
                                    ${yVals && yVals.length > 0 ? yVals[yVals.length-1]?.reduce((acc, curr) => acc + curr[1], 0).toFixed(1) : '0.0'}
                                </div>
                            </div>
                            ...
                            <div className="w-full h-full flex items-center justify-center">
                                <div className="w-10/12 h-5/6  rounded-lg border-y border-slate-600 p-2">
                                    ...
                                    <div className="h-[25%] w-full flex gap-2 items-center py-2">
                                        {
                                            sp && sp.length > 0 ? sp.map((item, ind) => (
                                                <div
                                                    key={`stock-${ind}`}
                    ...
                    <div className="w-full h-full flex p-4 border-y border-slate-400 gap-4 overflow-x-auto">
                        {
                            news && news.length > 0 ? news.map((item, index) => {
                                ...
                                return (
                                    <a style={{backgroundColor: rgb}} key={item.id || `news-${index}`} href={item.url} className="focus:outline-none grid grid-rows-[60%_40%] hover:bg-amber-100 transition-colors hover:cursor-pointer w-full border-x border-slate-300 h-full ">
                    ...
                    <div
                        ...
                        <div className="w-full h-full pl-8 grid grid-cols-[8%_92%]">
                            ...
                            <div className="w-full h-full pl-8">
                                {yVals && yVals.length > 0 && !viewBudget && <CumuPlot yData={yVals[yVals.length - 1]}/>}
